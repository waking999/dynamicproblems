...
public class DSGreedyRegretTest {
	...
	public void testKONET() throws InterruptedException, IOException,
		...
		String destFile = "out/output-DSGreedyRegret-KONECT.csv";
 ...
 @Ignore
	...
	public void testDIMACS() throws InterruptedException, IOException,
			FileNotFoundException {
		String destFile = "out/output-DSGreedyRegret-DIMACS.csv";
	...
	public void testBHOSLIB() throws InterruptedException, IOException,
			FileNotFoundException {
		String destFile = "out/output-DSGreedyRegret-BHOSLIB.csv";
	...
	// "queen16_16.col", "queen5_5.col", "queen6_6.col", "queen7_7.col",
	// "queen8_12.col", "queen8_8.col", "queen9_9.col", "school1.col",
