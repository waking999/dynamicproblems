...
public class GreedyDSMHDUTest {
	private Logger log = LogUtil.getLogger(GreedyDSMHDUTest.class);
	private static final String CLASS_NAME = GreedyDSMHDUTest.class.getSimpleName();
		...
		for (TestParameter tp : tps) {
			...
			if (tp.isBeTest()) {
				...
				for (int i = iStart; i <= iEnd; i++) {
					...
					IGreedyDS<Integer> ag01 = new GreedyDSMH1DU(am, k, r);
					...
					IGreedyDS<Integer> ag02 = new GreedyDSMH2DU(am, k, r);
