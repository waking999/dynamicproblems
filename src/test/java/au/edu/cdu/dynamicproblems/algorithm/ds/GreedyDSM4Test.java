...
public class GreedyDSM4Test {

	private Logger log = LogUtil.getLogger(GreedyDSM4Test.class);
	private static final String CLASS_NAME = GreedyDSM4Test.class.getSimpleName();
	...
	private void basicFunc(String inputFile, String destFile, int k, int r)
		...
		IGreedyDS<Integer> ag = new GreedyDSM4(am, k, r);
