...
@Deprecated
public class IGreedyDSVATest {
	Logger log = LogUtil.getLogger(IGreedyDSVATest.class);
...
//			run(ag2, path + file, krArray, destFile, resultMap);
	...
	private void run(IGreedyDSVA ag, String inputFile, int[][] krArray, String destFile,
