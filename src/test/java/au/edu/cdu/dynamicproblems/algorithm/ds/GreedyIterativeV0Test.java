...
public class GreedyIterativeV0Test {

	private Logger log = LogUtil.getLogger(GreedyIterativeV0Test.class);
			...
			for (String file : files) {
				...
				for (int k = iStart; k <= iEnd; k++) {
					...
					for (int i = 0; i < times[j]; i++) {
						...
						GreedyIterativeV0 ag = new GreedyIterativeV0(this.getClass().getName(),am);
						ag.run();
