...
public class GreedyDSCompleteTest  {
	Logger log = LogUtil.getLogger(GreedyDSCompleteTest.class);
	...
	public void testKONET() throws MOutofNException, ExceedLongMaxException,
		...
		String destFile = "out/output-GreedyDSComplete-KONECT-"+timeStamp+".csv";
	...
	public void testDIMACS() throws MOutofNException, ExceedLongMaxException,
		...
		String[] files = { // "C1000.9.clq",
				...
				// "MANN_a27.clq",
				// "MANN_a81.clq",
				"brock200_2.clq", "brock200_4.clq", "brock400_2.clq",
				"brock400_4.clq", "brock800_2.clq", "brock800_4.clq",
				// "gen200_p0.9_44.clq",
				// "gen200_p0.9_55.clq",
				// "gen400_p0.9_55.clq",
				// "gen400_p0.9_65.clq",
...
//
//	}
	private void runGreedyDDSKR(String inputFile, int[][] krArray, String destFile)
			...
			ArraysNotSameLengthException, IOException {
				...
				for (int[] kr : krArray) {
					...
					for (int r = 1; r <= rUpper; r++) {
						...
						GreedyDSComplete ag = new GreedyDSComplete("GreedyDDSTest", am, k, r);
