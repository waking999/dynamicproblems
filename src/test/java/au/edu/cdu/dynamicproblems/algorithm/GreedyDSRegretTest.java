...
public class GreedyDSRegretTest {
	private Logger log = LogUtil.getLogger(GreedyDSRegretTest.class);
	...
	public void testKONET() throws MOutofNException, ExceedLongMaxException,
		...
		String destFile = "out/output-GreedyDSRegret-KONECT-"+timeStamp+".csv";
	...
	private void runGreedyDDSKR(String inputFile, int[][] krArray,
		...
		for (int[] kr : krArray) {
			...
			for (int r = 1; r <= rUpper; r++) {
				...
				GreedyDSRegret ag = new GreedyDSRegret("GreedyDDSRegretTest",
						am, k, r);
