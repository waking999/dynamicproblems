...
public class GreedyDSM5Test {

	private Logger log = LogUtil.getLogger(GreedyDSM5Test.class);
	private static final String CLASS_NAME = GreedyDSM5Test.class.getSimpleName();
