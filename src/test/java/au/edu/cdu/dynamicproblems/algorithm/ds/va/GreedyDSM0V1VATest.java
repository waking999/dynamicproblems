...
import au.edu.cdu.dynamicproblems.algorithm.ds.va.GreedyDSM0V1VA;
...
public class GreedyDSM0V1VATest {

	private Logger log = LogUtil.getLogger(GreedyDSM0V1VATest.class);
	private static final String CLASS_NAME = GreedyDSM0V1VATest.class.getSimpleName();
	...
	public void test0() throws InterruptedException, IOException, FileNotFoundException {
		...
		int k = 10;
		int r = 10;
		IGreedyDS<Integer> ag = new GreedyDSM0V1VA(am, k, r);
