...
import au.edu.cdu.dynamicproblems.algorithm.GreedyDDSImp;
...
@Deprecated
public class GreedyDDSImpMain extends AbstractAlgorithmMain {
	private static Logger log = LogUtil.getLogger(GreedyDDSImpMain.class);
	...
	static {
		...
		inputFileMap.put("1000_0.3_2_testcase_a",
	...
	public static void main(String[] args) throws Exception {
		...
		new GreedyDDSImpMain().runSingleThread();
	...
	void runSingleThread() throws Exception {
		runSingleThread(new IThreadFunc() {
			...
			public void threadFunc(ThreadFuncParameter tfp)
				...
				GreedyDDSImp ag = new GreedyDDSImp(tfp.getIndicator(),
						tfp.getAm(), tfp.getK(), tfp.getR());
				Result result = null;
	...
	void runMajority(TaskContainer tc, IThreadFunc tf)
		...
		for (String key : keySet) {
			...
			int[][] krArray = { { 200, 2 }, { 200, 3 }, { 300, 2 }, { 300, 3 },
					{ 500, 2 }, { 500, 3 }, { 500, 4 } };
