...
@Deprecated
public class GreedyIterativeV1VA implements ITask, IAlgorithm {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyIterativeV1VA.class);
	...
	public GreedyIterativeV1VA(List<String[]> adjacencyMatrix) {
	...
	public GreedyIterativeV1VA(String indicator, List<String[]> adjacencyMatrix) {
	...
	public GreedyIterativeV1VA(Graph<Integer, Integer> g) {
		this.g = g;
