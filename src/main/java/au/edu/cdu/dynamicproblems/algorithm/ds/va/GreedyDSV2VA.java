/**
 * implement Michael's original idea but with utility rather than degree
 */
...
@Deprecated
public class GreedyDSV2VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSV2VA.class);
	...
	public GreedyDSV2VA(String indicator, List<String[]> am, int k, int r) {
	...
	private void preprocess() {
		...
		// gInitial
		Integer v0=this.vdOriginalMap.firstKey();
		Integer u0 = getHighestUtilityNeighborOfAVertex(v0, vdOriginalMap);
