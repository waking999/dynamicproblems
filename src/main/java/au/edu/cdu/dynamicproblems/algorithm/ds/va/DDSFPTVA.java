...
@Deprecated
public class DDSFPTVA implements IAlgorithm, ITask {
	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(DDSFPTVA.class);
	...
	public DDSFPTVA(String indicator, List<String[]> adjacencyMatrix2, List<Integer> dominatingSet1, int r) {
	...
	public DDSFPTVA(String indicator, Graph<Integer, Integer> g2, List<Integer> dominatingSet1, int r) {
		this.indicator = indicator;
		this.ds1 = dominatingSet1;
		this.g2 = g2;
		this.r = r;
	...
	private void reductionRulesOnGraph2() {
		...
		// AlgorithmUtil.addElementToList(vertexSections,
	...
	private void domAVcFpt(Collection<Integer> vertexCover, Graph<Integer, Integer> gStar, int r)
		...
		do {
			...
			ag = new DomAVCFPTVA(gStar, (List<Integer>) vertexCover, tryR);
