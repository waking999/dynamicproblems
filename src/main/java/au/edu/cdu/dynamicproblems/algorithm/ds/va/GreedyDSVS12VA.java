...
@Deprecated
public class GreedyDSVS12VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSVS12VA.class);
	...
	public GreedyDSVS12VA(String indicator, List<String[]> am, int k, int r) {
