 ...
 *
 */
public class GreedyDSMH2DU implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSMH2DU.class);
	...
	public GreedyDSMH2DU(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
