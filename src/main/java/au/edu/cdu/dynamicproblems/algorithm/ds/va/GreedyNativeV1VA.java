...
@Deprecated
public class GreedyNativeV1VA implements ITask, IAlgorithm {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyNativeV1VA.class);
	...
	public GreedyNativeV1VA(List<String[]> adjacencyMatrix) {
	...
	public GreedyNativeV1VA(String indicator, List<String[]> adjacencyMatrix) {
	...
	public GreedyNativeV1VA(Graph<Integer, Integer> g) {
		this.g = g;
