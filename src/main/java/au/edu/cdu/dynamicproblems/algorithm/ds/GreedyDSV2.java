...
public class GreedyDSV2 implements IGreedyDS, ITask {
	...
	private static Logger log = LogUtil.getLogger(GreedyDSV2.class);
	...
	public GreedyDSV2(String indicator, List<String[]> am, int k, int r) {
	...
	private void start()
		...
		while (!AlgorithmUtil.isAllDominated(dominatedMap)) {
			...
			TreeMap<Integer, Integer> vdMap=AlgorithmUtil.sortVertexMapAccordingToUtilityInclude(gOriginal, dominatedMap, undominatedVertices);
