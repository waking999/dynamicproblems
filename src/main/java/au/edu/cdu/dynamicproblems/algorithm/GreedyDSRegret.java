...
public class GreedyDSRegret implements IGreedyDS, ITask {
	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSRegret.class);
	...
	public GreedyDSRegret(String indicator, List<String[]> am, int k, int r) {
	...
	public GreedyDSRegret(String indicator) {
		this.indicator = indicator;
