...
public class GreedyDSMV1 implements ITask, IAlgorithm {

	private static Logger log = LogUtil.getLogger(GreedyDSMV1.class);
	...
	public Result getResult() {
		return GreedyDSUtil.getResult(this.dominatingSet, this.runningTimeMap);
	}
	...
	public GreedyDSMV1(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
