...
public class GreedyDSM0V0 implements ITask, IAlgorithm {
	...
	public GreedyDSM0V0(List<String[]> adjacencyMatrix) {
	...
	public GreedyDSM0V0(String indicator, List<String[]> adjacencyMatrix) {
