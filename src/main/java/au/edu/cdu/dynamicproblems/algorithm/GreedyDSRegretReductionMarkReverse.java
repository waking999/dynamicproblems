...
public class GreedyDSRegretReductionMarkReverse implements IGreedyDS, ITask {
	...
	public GreedyDSRegretReductionMarkReverse(String indicator, List<String[]> am,
			int k, int r) {
	...
	public GreedyDSRegretReductionMarkReverse(String indicator) {
		this.indicator = indicator;
