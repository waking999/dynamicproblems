...
@Deprecated
public class GreedyDSV4VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private List<Integer> ds1;
	
	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSV4VA.class);
	...
	public GreedyDSV4VA(String indicator, List<String[]> am, int k, int r,List<Integer> ds1) {
