...
public class DSGreedyIterative implements IAlgorithm, ITask {
	...
	public DSGreedyIterative(List<String[]> adjacencyMatrix) {
	...
	public DSGreedyIterative(String indicator, List<String[]> adjacencyMatrix) {
	...
	public DSGreedyIterative(Graph<Integer, Integer> g) {
		this.g = g;
