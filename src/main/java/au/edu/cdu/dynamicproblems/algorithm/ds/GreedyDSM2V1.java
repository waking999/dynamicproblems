...
public class GreedyDSM2V1 implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM2V1.class);
	...
	public GreedyDSM2V1(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
