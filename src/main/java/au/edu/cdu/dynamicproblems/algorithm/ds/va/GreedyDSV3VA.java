...
@Deprecated
public class GreedyDSV3VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSV3VA.class);
	...
	public GreedyDSV3VA(String indicator, List<String[]> am, int k, int r) {
