...
@Deprecated
public class GreedyDSVS14VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSVS14VA.class);
	...
	public GreedyDSVS14VA(String indicator, List<String[]> am, int k, int r) {
