 ...
 *
 */
public class GreedyDSM3WW implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM3WW.class);
	...
	public GreedyDSM3WW(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
	...
	private void greedy()
		...
		initWeightVote(vertices, verticesSize);
	...
	private void initWeightVote(Collection<Integer> vertices, int verticesSize) {
