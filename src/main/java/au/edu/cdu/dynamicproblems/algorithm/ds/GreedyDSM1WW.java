 ...
 *
 */
public class GreedyDSM1WW implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM1WW.class);
	...
	public GreedyDSM1WW(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
