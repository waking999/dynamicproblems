 ...
 *
 */
public class GreedyDSM0VV implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM0VV.class);
	...
	public GreedyDSM0VV(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
	...
	private void greedy()
		...
		Integer u = AlgorithmUtil.getHighestVoteNeighborOfAVertex(v, g, weightMap);
