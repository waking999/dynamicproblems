...
public class GreedyDSComplete implements IGreedyDS, ITask {
	...
	public GreedyDSComplete(String indicator, List<String[]> am, int k, int r) {
		this.indicator = indicator;
		this.am = am;
		this.k = k;
		this.r = r;
	...
	public GreedyDSComplete(String indicator){
		this.indicator=indicator;
		this.ds=null;
	}
