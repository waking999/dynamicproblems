 ...
 *
 */
public class GreedyDSM0V1 implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM0V1.class);
	...
	public GreedyDSM0V1(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
