...
@Deprecated
public class GreedyDSVS11VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSVS11VA.class);
	...
	public GreedyDSVS11VA(String indicator, List<String[]> am, int k, int r) {
