...
@Deprecated
public class GreedyDSCompleteVA implements IGreedyDSVA, ITask {
	...
	//private static Logger log = LogUtil.getLogger(GreedyDSComplete.class);
	...
	public GreedyDSCompleteVA(String indicator, List<String[]> am, int k, int r) {
		this.indicator = indicator;
		this.am = am;
		this.k = k;
		this.r = r;
	...
	public GreedyDSCompleteVA(String indicator){
		this.indicator=indicator;
		this.ds=null;
	}
	...
	private void start() throws MOutofNException, ExceedLongMaxException,
		...
		do {
			...
			DDSFPTVA ag = new DDSFPTVA(indicator, gICopy, ds1, r);
