...
@Deprecated
public class GreedyDSVS03VA implements IGreedyDSVA, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSVS03VA.class);
	...
	public GreedyDSVS03VA(String indicator, List<String[]> am, int k, int r) {
