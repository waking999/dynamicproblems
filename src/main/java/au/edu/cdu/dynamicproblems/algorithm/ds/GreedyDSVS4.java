...
public class GreedyDSVS4 implements IGreedyDS, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSVS4.class);
	...
	public GreedyDSVS4(String indicator, List<String[]> am, int k, int r) {
