 ...
 *
 */
public class GreedyDSM02WW implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM02WW.class);
	...
	public GreedyDSM02WW(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
	...
	private void greedy()
		...
		// sort a list of vertex from highest vote to lowest
		List<Integer> vList = OrderPackageUtil.getVertexListWeightDesc(g, weightMap);
