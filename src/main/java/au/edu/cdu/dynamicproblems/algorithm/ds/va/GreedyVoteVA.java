 ...
 */
@Deprecated
public class GreedyVoteVA implements ITask, IAlgorithm {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyVoteVA.class);
	...
	public GreedyVoteVA(List<String[]> adjacencyMatrix) {
	...
	public GreedyVoteVA(String indicator, List<String[]> adjacencyMatrix) {
	 ...
	 *            a graph instance
	 */
	public GreedyVoteVA(Graph<Integer, Integer> g) {
		this.g = g;
