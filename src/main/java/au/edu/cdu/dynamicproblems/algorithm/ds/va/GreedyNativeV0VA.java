...
import au.edu.cdu.dynamicproblems.algorithm.ds.va.GreedyNativeVATest;
...
@Deprecated
public class GreedyNativeV0VA implements IAlgorithm, ITask {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyNativeVATest.class);
	...
	public GreedyNativeV0VA(String indicator, List<String[]> am) {
