...
public class GreedyDSRegretReduction implements IGreedyDS, ITask {
	@SuppressWarnings("unused")
	private static Logger log = LogUtil
			.getLogger(GreedyDSRegretReduction.class);
	...
	public GreedyDSRegretReduction(String indicator, List<String[]> am, int k,
			int r) {
	...
	public GreedyDSRegretReduction(String indicator) {
		this.indicator = indicator;
