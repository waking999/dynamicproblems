...
public class DDSFPTV1 implements IAlgorithm, ITask {
	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(DDSFPTV1.class);
	...
	public DDSFPTV1(String indicator, List<String[]> adjacencyMatrix2, List<Integer> dominatingSet1, int r) {
	...
	public DDSFPTV1(String indicator, Graph<Integer, String> g2, List<Integer> dominatingSet1, int r) {
		this.indicator = indicator;
		this.ds1 = dominatingSet1;
		this.g2 = g2;
		this.r = r;
	...
	private void domAVcFpt(Collection<Integer> vertexCover, Graph<Integer, String> gStar, int r)
		...
		do {
			...
			ag = new DomAVCFPTV1(gStar, (List<Integer>) vertexCover, tryR);
