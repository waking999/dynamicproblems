...
import au.edu.cdu.dynamicproblems.algorithm.ds.MomentOfRegretDelta;
...
public class GreedyDSM1V0VA implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM1V0VA.class);
	...
	public GreedyDSM1V0VA(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
