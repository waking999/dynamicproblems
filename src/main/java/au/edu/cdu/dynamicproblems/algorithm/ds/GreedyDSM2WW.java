 ...
 *
 */
public class GreedyDSM2WW implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM2WW.class);
	...
	public GreedyDSM2WW(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
