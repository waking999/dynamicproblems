 ...
 *
 */
public class GreedyDSMH2WW implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSMH2WW.class);
	...
	public GreedyDSMH2WW(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
