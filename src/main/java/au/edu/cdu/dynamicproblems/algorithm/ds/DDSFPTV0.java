...
public class DDSFPTV0 implements IAlgorithm, ITask {
	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(DDSFPTV0.class);
	...
	public DDSFPTV0(String indicator, List<String[]> adjacencyMatrix2, List<Integer> dominatingSet1, int r) {
	...
	public DDSFPTV0(String indicator, Graph<Integer, Integer> g2, List<Integer> dominatingSet1, int r) {
		this.indicator = indicator;
		this.ds1 = dominatingSet1;
		this.g2 = g2;
		this.r = r;
	...
	private void domAVcFpt(Collection<Integer> vertexCover, Graph<Integer, Integer> gStar, int r)
		...
		do {
			...
			ag = new DomAVCFPTV0(gStar, (List<Integer>) vertexCover, tryR);
