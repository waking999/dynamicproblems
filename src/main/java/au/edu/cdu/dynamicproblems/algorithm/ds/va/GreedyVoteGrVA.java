 ...
 */
@Deprecated
public class GreedyVoteGrVA implements ITask, IAlgorithm {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyVoteGrVA.class);
	...
	public GreedyVoteGrVA(List<String[]> adjacencyMatrix) {
	...
	public GreedyVoteGrVA(String indicator, List<String[]> adjacencyMatrix) {
	...
	public GreedyVoteGrVA(Graph<Integer, Integer> g) {
		this.g = g;
		this.numOfVertices = g.getVertexCount();

	}

	public GreedyVoteGrVA(String indicator, Graph<Integer, Integer> g) {
		this.indicator = indicator;
		this.g = g;
		this.numOfVertices = g.getVertexCount();
	}
