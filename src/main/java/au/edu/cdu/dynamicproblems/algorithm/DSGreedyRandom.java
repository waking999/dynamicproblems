...
public class DSGreedyRandom implements IAlgorithm, ITask {
	...
	public DSGreedyRandom(List<String[]> adjacencyMatrix) {
	...
	public DSGreedyRandom(String indicator, List<String[]> adjacencyMatrix) {
	...
	public DSGreedyRandom(Graph<Integer, Integer> g) {
		this.g = g;
