 ...
 *
 */
public class GreedyDSM2DU implements ITask, IGreedyDS<Integer> {

	@SuppressWarnings("unused")
	private static Logger log = LogUtil.getLogger(GreedyDSM2DU.class);
	...
	public GreedyDSM2DU(List<String[]> adjacencyMatrix, int k, int rUpperBoundary) {
